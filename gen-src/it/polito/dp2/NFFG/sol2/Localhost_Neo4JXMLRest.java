...
import org.example.neo4j.Labels;
import org.example.neo4j.Paths;

@Generated(value = {
    "wadl|http://localhost:8080/Neo4JXML/rest/application.wadl"
}, comments = "wadl2java, http://wadl.java.net", date = "2017-01-04T18:53:19.303-08:00")
public class Localhost_Neo4JXMLRest {
    ...
    public static class Resource {
        ...
        public static class Node {
            ...
            public org.example.neo4j.Node postXmlAsNode(org.example.neo4j.Node input) {
                ...
                return response.getEntity(org.example.neo4j.Node.class);
            }
        ...
        public static class NodeNodeid {
            ...
            public org.example.neo4j.Node getAsNode() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
        ...
        public static class NodeNodeidRelationship {
            ...
            public org.example.neo4j.Relationship postXmlAsRelationship(org.example.neo4j.Relationship input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(org.example.neo4j.Relationship.class);
            }
        ...
        public static class Nodes {
            ...
            public org.example.neo4j.Nodes getAsNodes() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(org.example.neo4j.Nodes.class);
            }
        ...
        public static class RelationshipRelationshipid {
            ...
            public org.example.neo4j.Relationship getAsRelationship() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
